...
public class ProjetoCommandController {
    ...
    public ProjetoResponse atualizar(
            ...
            @RequestBody @Valid ProjetoUpdateRequest request
    ) {
        var dominio = service.buscarDomainPorId(id);
        updateMapper.updateDomainFromRequest(request, (Projeto) dominio);
        return service.atualizar(id, (Projeto) dominio, request.alunosIds(), request.stacksIds());
    }
